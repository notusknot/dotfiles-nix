...
# but I choose to have it in a seperate file to keep it more clean.  This file also imports my custom build of st.
...
let 
    ...
    regularPackages = with pkgs; [
        ...
        # Games
        minecraft lutris multimc

        # Development
        neovim git gcc gnumake gnupatch lua jdk11 python3 nodejs
